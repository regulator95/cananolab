...
/*!40000 ALTER TABLE `users`
    DISABLE KEYS */;
INSERT INTO `users`
VALUES ('guest1', '$2a$10$igGk864rQo.kmKRushHSkuFY2yCrpzII7AxuW.M2RKXq5C2QivCR6', 'caNanoLab', 'Guest', '', '', '', '',
        '', '1'),
       ('guest2', '$2a$10$lIqpk.0UQfL6qVIffOvF.OF1LdLtf2ARF8FyhliKtzEl/u8XY7LM2', 'caNanoLab', 'Guest', '', '', '', '',
        '', '1'),
       ('canano_curator', '$2a$10$MQOl654LL.NvxSM4gGqXgeJxwU5fCpD3TAUJyn//BdARZtztgUVuO', 'caNanoLab', 'Guest', '', '',
        '', '', '', '1'),
       ('canano_guest', '$2a$10$wSoRoTa5XSJiFrac.fqFWObIVxaoFPPtg9RAGu.y4ZIP4rqjKHTW6', 'caNanoLab', 'Guest', '', '',
        '', '', '', '1'),
       ('canano_res1', '$2a$10$L.zYgxxKhDEdr6.carHNjOAxk9bfnh6Myoknxjb1hqpJztch4Kfsu', 'caNanoLab', 'Guest', '', '', '',
        '', '', '1'),
       ('canano_res', '$2a$10$A.r7AY4TlSGR7XFM1Jj5.OiuOhNz3Cq45SyPxqiWoH/L6Cg5KNnyO', 'caNanoLab', 'Guest', '', '', '',
        '', '', '1'),
       ('guest7', '$2a$10$viypjlwpitaZC3BCXTYHyOr4c4jFxeCEe4LGaBeweba/krQFfvd2a', 'caNanoLab', 'Guest', '', '', '', '',
        '', '1'),
       ('guest8', '$2a$10$ZM.QQEiVye9.wS1S39jkceeBrAFSg.wWjo5V9ICVtldlaIIHZR5cG', 'caNanoLab', 'Guest', '', '', '', '',
        '', '1'),
       ('guest9', '$2a$10$zsvrNgGtEg9iR1UsrDKxveYqrClaoRVFi0UlIAsMkgqje5LmSuDVm', 'caNanoLab', 'Guest', '', '', '', '',
        '', '1');
/*!40000 ALTER TABLE `users`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES ('canano_curator', 'ROLE_ANONYMOUS'),
       ('canano_guest', 'ROLE_ANONYMOUS'),
       ('canano_res', 'ROLE_ANONYMOUS'),
       ('canano_res1', 'ROLE_ANONYMOUS');
/*!40000 ALTER TABLE `authorities`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (5308416, 'MIT_MGH', '', '', '', 'MA', '', '', '2008-08-20 00:00:00', 'canano_admin'),
       ...
       (12288000, 'KU_JSTC_JAPAN', '', '', '', '', '', '', '2009-05-07 00:00:00', 'canano_admin'),
       ...
       (24030464, 'C-Sixty (CNI)', '', '', '', '', '', '', '2007-05-17 00:00:00', 'canano_admin'),
       (24030465, 'Mark Kester PSU', NULL, NULL, NULL, NULL, NULL, NULL, '2007-06-08 00:00:00', 'canano_admin'),
       (25767168, 'Nanotechnology Characterization Laboratory', '', '', '', '', '', '', '2009-10-16 00:00:00',
        'canano_admin'),
       ...
       (30146560, 'Childrens Hospital Los Angeles', '4650 Sunset Boulevard SRT 302',
        ...
        'canano_admin'),
       (31326208, 'caNanoLab', '', '', '', '', '', '', '2011-10-17 16:41:50', 'canano_guest'),
       (31326209, 'NIEHS', '', '', '', '', '', '', '2011-10-18 12:09:54', 'canano_guest'),
       (31326210, 'Nanotechnology_Characterization_Laboratory', '', '', '', '', '', '', '2011-10-18 14:52:26',
        'canano_admin'),
       ...
       (33128449, 'UTHSCH_UMG_MDACC_RU_UTA', 'Department of Nanomedicine and Biomedical Engineering',
        'The University of Texas Health Science Center at Houston', 'Houston', 'TX', '', 'USA', '2012-06-27 11:51:03',
        'canano_admin'),
       (34144256, 'SNL_UNM', '', '', '', '', '', 'USA', '2012-07-26 15:09:31', 'canano_admin'),
       (35782656, 'BB_SH_DFCI_WCMC_BWH_MIT', 'test', 'test', 'rockville', 'md', '20850', 'usa', '2012-09-25 12:54:51',
        'canano_admin'),
       (36306944, 'BB_SH_KCI_DFCI_WCMC_BWH_MIT', '', '', '', '', '', 'USA', '2012-09-25 12:54:51', 'canano_admin'),
       ...
       (41975809, 'TAM', '', '', '', '', '', '', '2014-03-28 11:32:21', 'canano_admin'),
       (41975810, 'National Cancer Institute', '', '', '', '', '', '', '2014-03-28 13:00:18', 'canano_admin'),
       (42958848, 'NCI Program', '', '', '', '', '', '', '2014-04-07 12:34:43', 'canano_admin'),
       ...
       (47611905, 'NIH', '', '', '', '', '', '', '2015-01-22 16:40:17', 'canano_admin'),
       ...
       (53379073, 'Caltech', '1200 E California Blvd', '', 'Pasadena', 'CA', '91125', 'USA', '2015-11-19 18:33:57',
        'canano_admin'),
       (54296576, '[other]', '', '', '', '', '', '', '2016-03-17 12:25:17', 'canano_admin'),
       ...
       (60522496, 'MC2TCN', '1275 York Ave', '', 'New York', 'NY', '10065', 'USA', '2017-01-06 14:41:17',
        'canano_admin'),
       (60719104, 'canano_admin', 'NCI', '', '', '', '', 'USA', '2017-01-24 12:15:06', 'canano_admin'),
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_synthesis_material_TO_synthesis_material_file` (`synthesis_material_pk_id`) REFERENCES `synthesis_material` (`synthesis_material_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_file_TO_synthesis_material_file` (`file_pk_id`) REFERENCES `file` (`file_pk_id`)
);
-- synthesis_material_file
...
# -- synthesis_material_file
# ALTER TABLE `canano`.`synthesis_material_file`
#     ADD CONSTRAINT `FK_file_TO_synthesis_material_file` -- file -> synthesis_material_file
#         FOREIGN KEY (
#                      `file_pk_id` -- file_pk_id
#             )
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_synthesis_TO_synthesis_functionalization` (`synthesis_pk_id`) REFERENCES `synthesis` (`synthesis_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_protocol_TO_synthesis_functionalization` (`protocol_pk_id`) REFERENCES `protocol` (`protocol_pk_id`)
);
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_syn_func_TO_syn_func_file` (`synthesis_functionalization_pk_id`) REFERENCES `synthesis_functionalization` (`synthesis_functionalization_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_file_TO_synthesis_file` (`file_pk_id`) REFERENCES `file` (`file_pk_id`)
);
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_synthesis_TO_synthesis_purification` (`synthesis_pk_id`) REFERENCES `synthesis` (`synthesis_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_protocol_TO_synthesis_purification` (`protocol_pk_id`) REFERENCES `protocol` (`protocol_pk_id`)
);
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_synthesis_material_TO_synthesis_functionalization_element` (`synthesis_functionalization_pk_id`)
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_synthesis_material_element_TO_sme_inherent_function` (`synthesis_material_element_pk_id`)
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_synthesis_material_element_TO_synthesis_material_element_file` (`synthesis_material_element_pk_id`)
        REFERENCES `synthesis_material_element` (`synthesis_material_element_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_file_TO_synthesis_material_element_file` (`file_pk_id`) REFERENCES `file` (`file_pk_id`)
);
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_synthesis_func_element_TO_sfe_element_file` (`synthesis_functionalization_element_pk_id`)
        REFERENCES `synthesis_functionalization_element` (`synthesis_functionalization_element_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_file_TO_synthesis_functionalization_element_file` (`file_pk_id`) REFERENCES `file` (`file_pk_id`)
);
...
(
    ...
    CONSTRAINT FOREIGN KEY (`synthesis_purification_pk_id`) REFERENCES `synthesis_purification` (`synthesis_purification_pk_id`)
);
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_purity_TO_purity_file` (`purity_pk_id`) REFERENCES `synthesis_purity` (`purity_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_file_TO_purity_file` (`file_pk_id`) REFERENCES `file` (`file_pk_id`)
);
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_synthesis_purification_TO_purification_config` (`synthesis_purification_pk_id`) REFERENCES `synthesis_purification` (`synthesis_purification_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_technique_TO_purification_config` (`technique_pk_id`) REFERENCES `technique` (`technique_pk_id`)
);
...
(
    ...
    CONSTRAINT FOREIGN KEY `FK_purification_config_TO_purification_config_instrument` (`purification_config_pk_id`)
        REFERENCES `purification_config` (`purification_config_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_instrument_TO_purification_config_instrument` (`instrument_pk_id`) REFERENCES `instrument` (`instrument_pk_id`)
);
...
(
    ...
    PRIMARY KEY (`datum_pk_id`, `condition_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_purity_datum_TO_purity_datum_condition` (`datum_pk_id`) REFERENCES `purity_datum` (`purity_datum_pk_id`),
    CONSTRAINT FOREIGN KEY `FK_experiment_condition_TO_purity_datum_condition` (`condition_pk_id`) REFERENCES `experiment_condition` (`condition_pk_id`)
);
